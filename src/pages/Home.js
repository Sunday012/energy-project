...
export default function Home() {
  ...
  return (
    <>
      <div className="First">
        <button onClick={handleTab1}>Solar Energy</button>
        <button onClick={handleTab2}>Wind Energy</button>
        <button onClick={handleTab3}>Hydro-Powered</button>
        <button onClick={handleTab4}>Biomass Energy</button>
        <button onClick={handleTab5}>Hydrogen</button>
        <button onClick={handleTab6}>Sound Energy</button>
      </div>
